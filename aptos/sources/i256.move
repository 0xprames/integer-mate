module integer_mate::i256 {
    ...
    fun test_from_overflow() {
        ...
        as_u256(from(0xffffffffffffffffffffffffffffffff));
    }

    #[test]
    fun test_neg_from() {
        assert!(as_u256(neg_from(0)) == 0, 0);
        assert!(as_u256(neg_from(1)) == 0xffffffffffffffffffffffffffffffff, 1);
        assert!(as_u256(neg_from(0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)) == 0x80000000000000000000000000000001, 2);
    ...
    #[test]
    fun test_abs() {
        assert!(as_u256(from(10)) == 10u128, 0); 
        assert!(as_u256(abs(neg_from(10))) == 10u128, 1); 
        assert!(as_u256(abs(neg_from(0))) == 0u128, 2); 
